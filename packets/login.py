...
from packets.character_creation import Packet as character_creation_packet
    ...
    if packet.status == LoginStatus.SUCCESS or packet.status == LoginStatus.SUCCESS_NEW_USER:
        ...
        if packet.status == LoginStatus.SUCCESS_NEW_USER:
            ...
            client.send_queue.put_nowait(
                character_creation_packet(name, crafting_skill, foraging_skill, combat_skill, ascetic_skill,
